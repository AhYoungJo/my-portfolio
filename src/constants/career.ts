...
export const mockIntroData: CareerIntroProps = {
  name: '조아영',
  title: 'Frontend Developer',
  summary:
    '기술을 통해 이로운 세상을 만드는 것을 목표로 합니다. 단순히 기술을 구현하는 것을 넘어, 서비스의 가치를 사용자에게 효과적으로 전달하는 데 중점을 둡니다. 지속 가능한 성장을 위한 견고한 설계에 관심이 많으며, 새로운 기술을 동료들과 함께 논의하고 실무에 적용하는 것을 좋아합니다.',
  highlights: [
    '협업과 소통의 중요성',
    '사용자 경험 중심',
    '현실적인 문제 해결',
...
export const mockExperiences: CareerExperience[] = [
  {
    company: '다온 H&S',
